...
const EntryPlus = () => {
    ...
    const handleTelephoneTypeChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
        setMember({...member, telephoneType:Number(event.target.value)});
      }
    
      const handleIntroductionChange = (event: React.ChangeEvent<HTMLTextAreaElement>) => {
        setMember({...member, introduction:event.target.value});
      }
    
      const handleAgreedChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        setMember({...member, agreed:event.target.checked});
      }
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            ...
            <Field className="flex gap-x-4 sm:col-span-2">
              <div className="flex h-6 items-center">
                ...
                <input type="checkbox" onChange={handleAgreedChange}/>
              </div>
